...
class Janela:
    ...
    def __init__(self, instancia_de_Tk):              
        ...
        label1 = Label(frame1, text="Nome:"); 
        label1.pack()
        entry1 = Entry(frame1); entry1.pack()
        label2 = Label(frame2, text="Sexo:"); 
        label2.pack()
        ...
        self.spin_altura = Spinbox(frame3, from_=0, to=150); 
        self.spin_altura.pack()

        self.peso = IntVar()
        label3 = Label(frame3, text="Peso(kg):"); label3.pack()
        self.spin_peso = Spinbox(frame3, from_=0, to=150); self.spin_peso.pack()

        label4 = Label(frame4, text="Resultado:"); 
        label4.pack()
                
        self.v = StringVar()
        label5 = Label(frame4, text="", textvariable=self.v); 
        label5.pack()
        
        button1 = Button(instancia_de_Tk, text="OK", command=self.calcula_imc); 
        button1.pack()
